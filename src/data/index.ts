...
export const exportToBackend = async (
    ...
    //The iv is set to 0. We are never going to reuse the same key so we dont
    //need to have an iv. (I hope thats correct..)
    ...
    try{
        ...
        if(json.id){
            ...
            window.prompt(`${t("alerts.uploadedSecurely")}`,urlString)
...
export const exportCanvas = async (
    type: ExportType,
    elements: readonly NonDeletedDrawbitElement[],
    appState: AppState,
...
export const loadScene = async (
    ...
    // Non- optional so we dont forget to pass it even if undefined
