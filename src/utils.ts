...
export const isWritableElement = (
    ...
    | HTMLDivElement =>
    (target instanceof HTMLElement && target.dataset.type === "wysiwyg") ||   
    target instanceof HTMLBRElement || //newline in 
    target instanceof HTMLTextAreaElement || 
    (target instanceof HTMLInputElement &&
...
/** return fontSize+fontFamily string for assignment to DOM elements */
 ...
 * with RTL characters , or intermediate( numbers etc) characters followed 
 * by RTL
 */
